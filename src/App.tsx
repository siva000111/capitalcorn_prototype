...
function App() {
  ...
  return (
    <div className="app-shell">
      <Sidebar active={section} onSelect={setSection} onOpenSearch={() => setSearchOpen(true)} />
      <main className="app-content">
        {section === 'Home' && <Home onSelectFund={navigateToFundHistory} />}
        {section === 'Investor library' && <InvestorLibrary />}
        {section === 'Startup library' && (
          <StartupLibrary jumpStartupId={jumpStartupId} onJumpHandled={() => setJumpStartupId(null)} />
        )}
